...
function interpretPoke(poke) {
  ...
  switch(poke){
    case 'ttar': poke = 'tyranituar'; break;
    case 'zap': poke = 'zapdos'; break;
  }
...
let types ={
  ...
  poison: new PokeType("Poison Type",0xe064e0, "Grass, Fairy","Ghost, Ground, Poison, Rock, Steel (x2)","Bug, Fairy, Fighting, Grass, Poison"),
  ground: new PokeType("Ground Type",0x966622, "Electric, Fire, Poison, Rock, Steel","Bug, Grass, Flying (x2)","Poison, Rock"),
  rock: new PokeType("Rock Type",0xba9560, "Bug, Flying, Fire, Ice","Fighting, Ground, Steel","Fire, Flying, Normal, Poison"),
  bug: new PokeType("Bug Type",0x82f722, "Psychic, Grass, Dark","Fightin, Fire, Flying, Ghost, Poison, Steel, Fairy","Fightin, Grass, Ground"),
  ghost: new PokeType("Ghost Type", 0x7526d6, "Ghost, Psychic","Dark, Normal (x2)","Bug, Poison, Normal (x2), Fighting (x2)"),
  steel: new PokeType("Steel Type", 0x005791, "Fairy, Ice, Rock","Electric, Fire, Steel, Water","Bug, Dragon, Fairy, Flying, Grass, Ice, Normal, Psychic, Rock, Steel, Poison (x2)"),
  fire: new PokeType("Fire Type", 0xff7b00, "Bug, Grass, Ice, Steel","Dragon, Fire, Rock, Water","Bug, Fairy, Fire, Grass, Ice, Steel"),
  water: new PokeType("Water Type", 0x0902e5, "Fire, Ground, Rock","Dragon, Grass, Water","Fire, Ice, Steel, Water"),
  grass: new PokeType("Grass Type", 0x017208, "Ground, Rock, Water","Bug, Dragon, Fire, Flying, Grass, Poison, Steel","Electric, Grass, Ground, Water"),
  electric: new PokeType("Electric Type", 0xfff600, "Flying, Water","Dragon, Electric, Grass, Ground (x2)","Electric, Flying, Steel"),
  psychic: new PokeType("Psychic Type", 0xff494c, "Fighting, Poison","Psychic, Steel, Dark (x2)","Fighting, Psychic"),
  ice: new PokeType("Ice Type", 0x509fd8, "Dragon, Flying, Grass, Ground","Fire, Ice, Steel, Water","Ice"),
  dark: new PokeType("Dark Type", 0x252728, "Ghost, Psychic","Dark, Fighting, Fairy","Dark, Ghost, Psychic (x2)"),
  dragon: new PokeType("Dragon Type", 0x036fa5, "Dragon","Steel, Fairy (x2)","Electric, Fire, Grass, Water"),
  fairy:  new PokeType("Fairy Type", 0xf9b6ee, "Dark, Dragon, Fighting","Fire, Poison, Steel","Bug, Dark, Fighting, Dragon (x2)")
}
...
// Zapdos #145
client.on('message', message => {
  if (message.content.toLowerCase() === '?zapdos' || message.content.toLowerCase() === "?Zapdos" || message.content.toLowerCase() === "?145") {
...
// Moltres #146
client.on('message', message => {
  if (message.content.toLowerCase() === '?Moltres' || message.content.toLowerCase() === "?moltres" || message.content.toLowerCase() === "?146") {
    const embed = new Discord.RichEmbed()
